import {
  Sparkles, ClipboardList, ShoppingCart, Package, FileUp, Users, Undo2, Receipt, Printer,
...
export function construirSlidesGuia(): SlideGuia[] {
  const slides: SlideGuia[] = [
    ...
    },
    {
      ...
      descricao:
        'O coração do sistema. Abra uma OS para o aparelho que ficou na bancada ou para a instalação que você vai fazer na casa do cliente. Ela caminha sozinha pelas etapas — orçamento, aprovação, execução, pronta — e o "Painel Diário" mostra a fila inteira já organizada. Na entrega, a OS vira venda e baixa as peças do estoque.'
    },
    {
    ...
    },
    {
      ...
      descricao:
        'Cadastre peças e serviços com preço, custo e quantidade — cada um ganha uma referência curta pra achar sem leitor. O sistema avisa sozinho quando uma peça está acabando.'
    },
    {
      ...
      descricao:
        'Chegou peça nova? Arraste o XML da nota fiscal pra dentro do sistema: ele cadastra os itens, o fornecedor e o custo real (com frete e impostos), e você só diz quanto quer de lucro. Na recompra, ele reconhece os itens e repõe o estoque sozinho.'
    },
    {
  ...
  slides.push(
    ...
    },
    {
      ...
      descricao:
        'Backup automático protege tudo, o acesso é trancado por PIN e cada técnico tem o seu — com as telas do gerente (dinheiro e configurações) reservadas ao gerente. Precisou de ajuda? O suporte está a um clique no menu lateral. Bora começar!'
    }
  )
