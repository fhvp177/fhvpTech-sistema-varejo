      ...
      return (
        <div className="space-y-4">
          ...
          {/*
            ...
            atendentes dividem o balcão e quem chega precisa entrar no próprio
            nome pra venda, e a comissão, saírem certas.
            ...
            com ele os botões dele na ordem de tabulação. Medido no varejo, que
            tem a mesma estrutura: os vendedores eram os focáveis 19, 20 e 21 de
            24 — uns vinte Tabs às cegas por cima de uma tela que nem dá pra ver.
