...
const Contas: FC = () => {
  ...
  /*
   * ⚠️ No varejo esta linha é `useEhCelular()`, porque lá o sistema também é
   * servido pelo navegador. A assistência só existe como aplicativo instalado,
   * então a resposta é sempre a mesma e a constante deixa isso dito.
   *
   * Se um dia ela for servida pela web, o hook do varejo vem junto — e ele
   * depende da constante de build `__ALVO__`, que aqui não existe.
   */
  const ehCelular = false
