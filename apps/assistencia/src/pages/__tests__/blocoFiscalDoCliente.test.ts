...
// coisa que o dono consegue dele é "preencha o CNPJ do cliente antes de
...
// o bloco de NCM passou quatro versões dentro do diálogo de fornecedor no
// varejo — ver camposFiscaisNoFormCerto.test.ts, que guarda o mesmo tipo de
// acidente na tela de produtos.
//
  ...
  it('vem DEPOIS do campo de CNPJ, senão o botão da Receita nasce inútil', () => {
    expect(
      ...
      'o bloco subiu para antes do CNPJ: o botão "Buscar na Receita" passa a pedir ' +
        'um CNPJ que o dono ainda não teve onde digitar'
