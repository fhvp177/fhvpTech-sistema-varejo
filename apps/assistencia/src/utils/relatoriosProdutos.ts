...
export type ProdutoRelatorio = {
  ...
  // Serviço não tem estoque pra contar numa prateleira, mas TEM referência —
  // por isso ele fica de fora do balanço e dentro da tabela de referências.
  // Quem filtra é o CHAMADOR: as duas telas que geram estes relatórios já
  // sabem o que estão listando, e filtrar aqui dentro esconderia a regra.
