                      ...
                      {!l.grade && (
                        <Select
                          ...
                          opcoes={[
                            ...
                            // Só peça. Mão de obra não chega de caminhão, e deixá-la na lista era um
                            // convite a vincular a linha da nota no item errado.
                            ...pecas.map((p) => ({ valor: String(p.id), rotulo: p.nome }))
                          ]}
                        />
                      )}
                      {l.grade && (
