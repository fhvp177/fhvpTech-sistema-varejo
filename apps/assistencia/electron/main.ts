...
import { registrarHandlersRecibos } from './ipc/recibos'
...
// userData pra ela ("FHVP Tech Assistencia"). Este app nasceu com o nome
// definitivo, então aqui não há pasta legada a renomear — o mecanismo do varejo
// fica de pé só pelo isolamento: a pasta do varejo instalado na mesma máquina
// nunca é candidata.
