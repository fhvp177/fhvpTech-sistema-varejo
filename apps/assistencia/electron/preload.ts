...
const api = {
  ...
  recibos: {
    listar: (mes?: string): Promise<RespostaIPC> => ipcRenderer.invoke('recibos:listar', mes),
    meses: (): Promise<RespostaIPC> => ipcRenderer.invoke('recibos:meses'),
    proximoNumero: (): Promise<RespostaIPC> => ipcRenderer.invoke('recibos:proximoNumero'),
    obter: (numero: number): Promise<RespostaIPC> => ipcRenderer.invoke('recibos:obter', numero),
    criar: (dados: unknown): Promise<RespostaIPC> => ipcRenderer.invoke('recibos:criar', dados),
    cancelar: (args: { numero: number; motivo: string }): Promise<RespostaIPC> =>
      ipcRenderer.invoke('recibos:cancelar', args)
  },
