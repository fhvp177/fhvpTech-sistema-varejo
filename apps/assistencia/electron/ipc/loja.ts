...
// Enquanto o gerente não preencher "Dados da loja", a identidade NUNCA traz
// dados de outra loja. No varejo este fallback chegou a trazer os da 1ª loja do
// mundo (GN Modas) chumbados, o que vazava a identidade dela pro cupom das lojas
// novas — lá o fallback virou branco e o legado foi pra migration
// 030_loja_identidade_legada (que aqui é no-op de propósito, veja o arquivo).
//
// A assistência nasceu depois disso e nunca teve legado, então a escolha aqui é
// diferente da do varejo por um motivo só: um cupom sem NENHUM cabeçalho parece
// impressora com defeito. Um rótulo genérico não é dado de ninguém e some assim
// que o gerente preencher a tela. Os demais campos ficam vazios e nem são
// impressos, porque as linhas do rodapé são condicionais.
