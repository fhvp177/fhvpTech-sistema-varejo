 ...
 *
 * ── Para que serve ──────────────────────────────────────────────────────────
 * O cliente busca o aparelho e paga por PIX no balcão, ou o técnico entrega em
 * casa e recebe lá. Quem atende vê o comprovante na tela do celular do cliente e
 * pronto: não fica prova nenhuma no sistema. Quando o valor não aparece na
 * conta, uma semana depois, a conversa é a palavra de um contra a do outro.
 *
