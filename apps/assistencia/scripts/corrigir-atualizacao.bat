...
REM ============================================================================
REM  FHVP Tech Assistencia - Corrigir o endereco de atualizacao
REM
...
if "%N%"=="0" (
  echo.
  echo  Nao encontrei o FHVP Tech Assistencia instalado neste computador.
  echo.
  ...
  echo    url: https://updates.fhvptech.com/assistencia/pro
  echo    updaterCacheDirName: fhvptech-assistencia-updater
  echo.
...
>>"!DESTINO!" echo url: https://updates.fhvptech.com/assistencia/%CANAL%
>>"!DESTINO!" echo updaterCacheDirName: fhvptech-assistencia-updater
