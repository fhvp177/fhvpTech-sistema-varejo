...
// os dados de outra máquina: numa instalação nova ninguém sabe o PIN do vendedor
...
//
// E sumia justamente onde importa — instalação nova nasce com UM vendedor
