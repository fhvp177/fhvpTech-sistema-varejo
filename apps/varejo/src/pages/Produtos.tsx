...
const Produtos: FC = () => {
  ...
  const salvar = async () => {
    ...
    // devolve 0, e sem esta linha um produto sem preço entraria valendo zero,
      ...
      <div className="hidden lg:flex items-start justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            O que a loja vende, com preço, custo e estoque. Produto com grade tem o estoque
            contado tamanho por tamanho.
          </p>
        </div>
