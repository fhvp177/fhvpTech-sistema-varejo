/*
 * Os dois primeiros pedidos do Neto Imports (06/09/2026).
 *
...
describe('cadastro rápido de cliente: endereço e observação', () => {
  ...
  it('★ o endereço se explica pela entrega', () => {
    // Não é campo pedido por pedir: sem endereço não existe entrega, que é como
    // boa parte das vendas desta loja acontece.
