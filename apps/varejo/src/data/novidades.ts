...
export const NOVIDADES: ReleaseNovidades[] = [
  {
    ...
    itens: [
      {
        emoji: '📊',
        titulo: 'Custo e lucro por dia',
        descricao:
          'O Painel passa a exibir, em cada dia, quanto do faturamento é custo dos '
          + 'produtos vendidos e quanto é lucro bruto, com destaque para o dia mais recente.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    itens: [
      {
        emoji: '🧾',
        titulo: 'Correção de falhas',
        descricao:
          'A nota fiscal do consumidor volta a ser impressa por inteiro na bobina, sem '
          + 'cortar a coluna de valores.'
      }
    ]
  },
  {
    ...
    itens: [
      {
        ...
        titulo: 'Correção de bugs',
        descricao:
          'Foram corrigidos pequenos problemas de exibição e no salvamento das preferências.'
      }
    ]
  },
  {
    ...
    itens: [
      {
        ...
        titulo: 'Comissão de vendedores',
        descricao:
          'O sistema passa a apurar a comissão dos vendedores por período e a registrar o pagamento realizado.'
      },
      {
        emoji: '⚙️',
        titulo: 'Configurações reorganizadas',
        descricao:
          'A tela de Configurações passa a apresentar suas seções em cartões recolhíveis.'
      },
      {
        emoji: '🛠️',
        titulo: 'Correção de bugs',
        descricao:
          'Foram corrigidas pequenas falhas de exibição nas listas de seleção do sistema.'
      }
    ]
  },
  {
