...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /*
      A observação é texto livre do vendedor: pode vir um endereço emendado ou
      uma palavra enorme sem espaço. O 'overflow-wrap: anywhere' corta no meio da
      palavra em vez de empurrar a linha para fora dos 68mm — na térmica, o que
      passa da largura não sai cortado na tela, sai ausente do papel.
    */
    .observacao {
      font-size: 10.5px;
      margin: 4px 0;
