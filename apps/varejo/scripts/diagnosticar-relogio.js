 ...
 * `licenca.heartbeat` e `database.sqlite` (pasta %APPDATA%\FHVP Tech Varejo)
...
function resolverPasta() {
  ...
  // Mesma ordem do destravar-relogio.bat: o nome da pasta mudou entre versoes.
  for (const nome of ['FHVP Tech Varejo', 'Sistema RT', 'sistema-rt']) {
