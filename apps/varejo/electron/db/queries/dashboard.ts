...
export function obterMetricasDashboard(intervalo: IntervaloDashboard): MetricasDashboard {
   ...
   * encolher inteiro assim que o lojista atualizasse um preço de compra, sem
   * que nenhuma venda tivesse mudado. Agora isso só acontece com a parte
   * antiga do histórico, e ela encolhe sozinha a cada venda nova.
   *
